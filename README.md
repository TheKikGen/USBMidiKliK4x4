...
8 virtual ports and 8 midi clock generators are now available in the routing engine. Below is an overview of what are possible path for an an inconming midi message, before reaching an out port :
